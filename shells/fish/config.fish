...
if test -d /usr/local/lib/ruby/gems/2.6.0/bin
  set -g -x PATH /usr/local/lib/ruby/gems/2.6.0/bin $PATH
end

if test -d /home/hmartin/Documents/workspace/puppet-editor-services
  set -g -x PATH /home/hmartin/Documents/workspace/puppet-editor-services $PATH
end
